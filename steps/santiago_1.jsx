export default function Santiago_1() {
    return(
        <div class="big_step" id="llegada_santiago">
            ...
            <div class="table_of_contents">
                <ul>
                    <li>
                        <a href="#step_premiers_instants">
                        <span class="title">Premiers instants</span>
                        </a>
                    </li>
                    <li>
                        <a href="#step_perte_ville">
                        <span class="title">Perte dans la ville</span>
                        </a>
                    </li>
                    <li>
                        <a href="#Rencontre de Nico">
                        <span class="title">Puerto Varas</span>
                        </a>
                    </li>
                    <li>
                        <a href="#step_recherche_appart">
                        <span class="title">Recherche d'un appartement</span>
                        </a>
                    </li>
                    <li>
                        <a href="#step_debut_vacances">
                        <span class="title">Début des vacances</span>
                        </a>
                    </li>
                </ul>
            </div>
...
{/* <!-- -------- Premiers instants -------- --> */}
            <div class="step_title" id="step_premiers_instants">
            ...
            <div class="step" >
                <div class="ligne">
                    ...
                    <div class="right_30">
                        <img src="../images/santiago_1/avion_vertical.jpg" width="100%"></img>
                    </div>
                </div>
                ...
                <div class="ligne">
                    <div class="left_70">
                        <div class="container">
                            <div class="tile">
                                <img src="../images/santiago_1/arbre_parc.jpg" alt=""></img>
                            </div>
                            <div class="tile">
                                <img src="../images/santiago_1/eglise.jpg" alt=""></img>
                            </div>
                            <div class="tile">
                                <img src="../images/santiago_1/echaffaudage_arbre.jpg" alt=""></img>
                            </div>
                            <div class="tile">
                                <img src="../images/santiago_1/cactus_carre.jpg" alt=""></img>
                            </div>
                            <div class="tile">
                                <img src="../images/santiago_1/course_velo.jpg" alt=""></img>
                            </div>
                        </div>
                    </div>
                    <div class="right_30">
...
{/* <!-- -------- Se perdre dans la ville -------- --> */}
            ...
            <div class="step" id="step_perte_ville">
                <div class="ligne">
                    <div class="left_70">
                    ...
                    <div class="right_30">
                        <img src="../images/santiago_1/carabineros.jpg" width="100%"></img>
                    </div>
                </div>                
            </div>
...
{/* <!-- -------- Se perdre dans la ville -------- --> */}
            ...
            <div class="step" id="step_rencontre_nico">
                ...
                <div class="ligne">
                    <div class="left_70">
                        <img src="../images/santiago_1/esc_2.jpg" width="100%"></img>
                    </div>
                    <div class="right_30">
...
{/* <!-- -------- Se perdre dans la ville -------- --> */}
            ...
            <div class="step" id="step_recherche_appart">
...
{/* <!-- -------- Début des vacances -------- --> */}
            ...
            <div class="step" id="step_debut_vacances">
                <div class="ligne">
                    <div class="left_70">
                    ...
                    <div class="right_30">
                        <img src="../images/santiago_1/coquitos.jpg" width="100%"></img>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="tile">
                        <img src="../images/santiago_1/cerro_rue.jpg" alt=""></img>
                    </div>
                    <div class="tile">
                        <img src="../images/santiago_1/arbre_cerro.jpg" alt=""></img>
                    </div>
                    <div class="tile">
                        <img src="../images/santiago_1/coucher_soleil.jpg" alt=""></img>
                    </div>
                    <div class="tile">
                        <img src="../images/santiago_1/hammac.jpg" alt=""></img>
                    </div>
                    <div class="tile">
                        <img src="../images/santiago_1/rio.jpg" alt=""></img>
                    </div>
                </div>
            </div>
